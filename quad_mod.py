...
### Trav's Laptop#########
f1 = open(r'C:\Users\Workstation 1\Documents\GitHub\Total_Epoxilation\root_planter_box_v4_solid-sliced (4).gcode', 'r') #input file
f3 = open(r'C:\Users\Workstation 1\Documents\GitHub\Total_Epoxilation\test_code_processed_11.gcode', 'w') #output file
