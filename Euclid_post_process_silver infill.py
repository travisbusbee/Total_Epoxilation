...
### Trav's Laptop#########
f1 = open(r'C:\Users\Workstation 1\Documents\GitHub\Total_Epoxilation\root_planter_box_v4_solid-sliced (7)_v8_g2_2.gcode', 'r') #input file
f3 = open(r'C:\Users\Workstation 1\Documents\GitHub\Total_Epoxilation\code_processed_touchpad_3.gcode', 'w') #output file
